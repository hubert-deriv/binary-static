...
const PaymentAgentList = () => (
    <div id='paymentagent_deposit'>
        ...
        <p data-show='-virtual' id='no_paymentagent' className='notice-msg center-text'>{it.L('Payment Agent services are not available in your country or in your preferred currency.')}</p>
